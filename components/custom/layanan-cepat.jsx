...
const data = [
    ...
    {
        "titile": "Anggota DPRD",
        "desc": "Informasi Anggota DPRD Waropen",
    ...
    },
    {
        ...
        "desc": "Layanan Pengaduan Langsung ke DPRD",
        "icon" : <Headset size={24}  className='group-hover:text-amber-500 text-white'/>,
        "imgUrl":"/5.jpeg",
        "link": "link",
    },
    {
        "titile": "Sekretariat DPRD",
        "desc": "Profil Sekretariat DPRD",
    ...
    },
    {
        ...
        "desc": "Akses Dokumen Laporan Keuangan DPRD",
