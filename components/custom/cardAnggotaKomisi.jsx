...
const CardAnggotaKomisi = ({nama, komisi, status, index}) => {
  return (
                ...
                <div className="w-[60%] group-hover:w-[50%] transition-all duration-300 ease-in-out h-full py-5 px-2 flex flex-col">
                    ...
                    <div className="w-full h-[50%] flex flex-col gap-2">
                        ...
                        <div className="flex flex-row items-center gap-1">
                            <span className="text-sm text-gray-200">KOMISI-{komisi}</span>
                        </div>
                    </div>

                    <div className="w-full h-[50%] flex items-end">
                        <div className="w-full py-5 border-t-2 border-t-amber-500 text-white text-sm text-center">
                            {status}
                        </div>
                    </div>
