...
const Card = ({imgUrl, judul, update, urlBerita}) => {
    return (
            <Link href={'/'} className="relative group h-60 w-full sm:w-[calc(50%-0.75rem)] md:w-[calc(25%-0.75rem)] overflow-hidden hover:shadow-amber-100 hover:shadow-sm" style={{backgroundImage: `url(${imgUrl})`, backgroundSize:'cover', backgroundPosition: 'center',}}>
                <div
                className="
