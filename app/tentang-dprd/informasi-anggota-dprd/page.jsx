...
const CardPerson = ({nama, komisi, fraksi}) => {
    return (
        <div className="flex-1 bg-[#231c26] hover:cursor-pointer group hover:shadow-violet-200  shadow rounded h-96 overflow-hidden">
            <div className="flex flex-row w-full h-full overflow-hidden">
                <div className="w-[40%] group-hover:w-[50%] transition-all duration-300 ease-in-out h-full overflow-hidden">
                    <Image alt="foto anggota dprk waropen" className="object-cover h-full w-full" height={300} width={300} src={"/ketua.jpeg"}  />
                </div>
...
const page = () => {
  return (
    <div className='w-full bg-[#110e12] pt-5 lg:px-16 px-10'>
