  ...
  return (
    <>
        ...
        <div className="lg:px-28 lg:text-xl flex flex-col gap-3">
            ...
            <ol type="a" class="list-[lower-alpha] pl-6 space-y-4 text-white lg:pl-20">
                <li>
                    <p class="font-semibold">Meningkatkan kualitas Pelayanan Dan Kinerja Aparatur Dalam Aspek Teknis Maupun Administratif.</p>
                    <p class="mt-1">
                ...
                <li>
                    <p class="font-semibold">Meningkatkan Penyediaan Fasilitas Pelayanan Guna Menunjang Fungsi dan Tugas Legislatif.</p>
                    <p class="mt-1">
                ...
                <li>
                    <p class="font-semibold">Meningkatkan Sumber Daya Aparatur Dalam Menunjang Fungsi dan kewenangan Legislatif.</p>
                    <p class="mt-1">
                ...
                <li>
                    <p class="font-semibold">Meningkatkan Kapasitas Lembaga Perwakilan Rakyat Daerah.</p>
                    <p class="mt-1">
