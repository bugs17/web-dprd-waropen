...
const VisiMisiPage = () => {
  return (
    <>
        ...
        <div className="lg:px-28 px-8 lg:text-xl pb-10 flex flex-col gap-3">
            ...
            <p className="text-white text-left lg:pl-20 pl-5">
            ...
            <ol type="a" className="list-[lower-alpha] pl-9 space-y-4 text-white lg:pl-20">
                <li>
